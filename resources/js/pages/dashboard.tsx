        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Pemantauan arus kas, saldo, dan anggaran periode {currentMonth}.
            </p>
          </div>
            ...
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                ...
                <Badge
                  ...
                  className={
                    netWorthNum >= 0
                      ? "text-[11px] border-emerald-500/30 text-emerald-600 dark:text-emerald-400 bg-emerald-500/10"
                      : "text-[11px] border-rose-500/30 text-rose-600 dark:text-rose-400 bg-rose-500/10"
                  }
                >
                  {netWorthNum >= 0 ? (
          ...
          <Card className="border-border/60 shadow-xs transition-shadow hover:shadow-sm">
            ...
            <CardFooter className="pt-0 flex flex-col gap-1.5 items-stretch text-xs">
              <div className="flex justify-between text-muted-foreground">
                ...
                <span
                  className={
                    budgetPercentage >= 90 ? "font-bold text-rose-600" : ""
                  }
                >
                  {budgetPercentage}%
                </span>
            ...
            <CardHeader className="flex flex-row items-center justify-between pb-3">
              <div>
                ...
                <CardDescription className="text-xs">
                  Aktivitas mutasi dana terakhir yang tercatat di sistem.
                </CardDescription>
              </div>
              <Link
                href="/transactions"
                ...
                <TableBody>
                  {recentTransactions.length === 0 ? (
                    ...
                    recentTransactions.map((t) => {
                      ...
                      const isTransfer = t.category?.type === "transfer";
